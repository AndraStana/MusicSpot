...
namespace Persistence.Migrations
{
    ...
    [Migration("20200517125516_addedSource2")]
    partial class addedSource2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Persistence.DAL.SimilarArtistsRelationship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("FirstArtistId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("SecondArtistId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("FirstArtistId");

                    b.HasIndex("SecondArtistId");

                    b.ToTable("SimilarArtistsRelationships");
                });
            ...
            modelBuilder.Entity("Persistence.DAL.Source", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Persistence.DAL.News", b =>
                {
                    b.HasOne("Persistence.DAL.Source", "Source")
                        .WithMany()
            ...
            modelBuilder.Entity("Persistence.DAL.SimilarArtistsRelationship", b =>
                {
                    b.HasOne("Persistence.DAL.Artist", "FirstArtist")
                        .WithMany("FirstArtists")
                        .HasForeignKey("FirstArtistId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Persistence.DAL.Artist", "SecondArtist")
                        .WithMany("SecondArtists")
                        .HasForeignKey("SecondArtistId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
